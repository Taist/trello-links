...
},{"q":8,"react/lib/DOMProperty":17,"react/lib/Object.assign":34}],2:[function(require,module,exports){
...
var AwesomeIcons, CustomSelect, CustomSelectOption, React, attrName, dataAttrName, div, input, ref;
...
CustomSelect = React.createFactory(React.createClass({
  componentDidMount: function() {
    ...
    return document.addEventListener("mousedown", this.onClickOutside);
  },
  componentWillUnmount: function() {
    document.removeEventListener('keyup', this.onKeyUp);
    return document.removeEventListener("mousedown", this.onClickOutside);
  },
  ...
  onClickOnInput: function() {
    return this.setState({
      ...
      return function() {
        var container, containerRect, optionRect, ref1;
        optionRect = (ref1 = _this.refs.selectedOption) != null ? ref1.getDOMNode().getBoundingClientRect() : void 0;
        if (optionRect) {
...
},{"./awesomeIcons":4,"react":163,"react/lib/DOMProperty":17}],6:[function(require,module,exports){
...
CardEditor = React.createFactory(React.createClass({
  ...
  render: function() {
    ...
    return div({
      ...
      className: 'window-module-title window-module-title-no-divider'
    }, span({
      className: 'window-module-title-icon icon-lg icon-card'
    }), h3({
      style: {
        display: 'inline-block'
      }
    ...
    }, this.state.isEditorActive ? span({
      className: 'icon-sm icon-remove',
...
},{"../taist/customSelect":5,"react":163,"react/lib/Object.assign":34}],7:[function(require,module,exports){
...
},{"./app":1,"./helpers/domObserver":2,"./helpers/insertAfter":3,"./react/trello/cardEditor":6,"q":8,"react":163}]},{},[]);
